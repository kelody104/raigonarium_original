...
export class GameTableSettingComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  createGameTable() {
    ...
    gameTable.backgroundImageIdentifier = 'testTableBackgroundImage_image_BG';
    gameTable.width = 38;
    gameTable.height = 38;

...
export class Terrain extends TabletopObject {
  ...
  @SyncVar() towername: string = "";
  @SyncVar() towerpoint: number = 0;
  @SyncVar() towercode: string = null;
  @SyncVar() RaigoFlag: boolean = false;
  @SyncVar() GoraFlag: boolean = false;
  @SyncVar() ownersID: string = null;
  @SyncVar() towers: Card[];
  @SyncVar() parts: string = "";
  @SyncVar() timer: boolean = false;
  @SyncVar() timer_A_min: number = 0;
  @SyncVar() timer_A_sec: number = 0;
  @SyncVar() timer_A_flag: boolean = true;
  @SyncVar() timer_B_min: number = 0;
  @SyncVar() timer_B_sec: number = 0;
  @SyncVar() timer_B_flag: boolean = false;

...
export class GameTableMask extends TabletopObject {
  ...
  get wallImage(): ImageFile { return this.getImageFile('floor'); }
  get opacity(): number {
  ...
  static create(name: string, width: number, height: number, floor: string, opacity: number, identifier?: string): GameTableMask {

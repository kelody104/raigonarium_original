...
export class PeerCursor extends GameObject {
  ...
  @SyncVar() PlayerID: number = 1;
  @SyncVar() GodeyeMode: boolean = Status.OrganizerMode;
  @SyncVar() GuideMode: boolean = false;
  @SyncVar() RaijinMode: boolean = false;
  @SyncVar() RotZ: number = 0;
  @SyncVar() towers: string[] = new Array();
  @SyncVar() towerpro: string[] = new Array();
  @SyncVar() points: number = 2;
  @SyncVar() uchigomas: number = 0;
  @SyncVar() raigotimes: number = 0;
  @SyncVar() choose: string = null;
  @SyncVar() choose_Lock: boolean = false;
  @SyncVar() MenuVisible: boolean = true;
  @SyncVar() partner: string = null;
  @SyncVar() Rank = null;

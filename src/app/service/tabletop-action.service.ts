...
import { dice } from 'json/dices.json';
import { Status } from 'json/status.json';
import { EventData } from 'json/history.json';;
import { OukaMenu, RengeMenu, CombiMenu, SpecialMenu, RaijinMenu, OtherMenu } from 'json/ichinichimenu.json';
